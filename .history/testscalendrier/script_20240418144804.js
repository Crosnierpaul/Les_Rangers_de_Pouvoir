document.addEventListener("DOMContentLoaded", function() {
    ...
    // Action lorsque l'utilisateur clique sur "Oui" dans la boîte de confirmation
    window.confirm = function(message) {
        return new Promise(resolve => {
            ...
            if (confirmation) {
                ...
                lastReservedSlot.classList.remove('reserved');
                const day = lastReservedSlot.getAttribute('data-day');
                const hour = lastReservedSlot.getAttribute('data-hour');
                reservations[hour][day] = false;
                reservationMade = false;
                lastReservedSlot = null;
            }
