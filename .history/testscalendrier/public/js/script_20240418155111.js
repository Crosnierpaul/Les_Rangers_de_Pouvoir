...
function sendDataToDatabase(data) {
    ...
    const apiUrl = 'http://localhost:3000/réservations'; // L'URL peut varier en fonction de votre configuration de serveur
    ...
    const requestOptions = {
        ...
        body: JSON.stringify(data) // Convertir les données en JSON pour l'envoi
    };
