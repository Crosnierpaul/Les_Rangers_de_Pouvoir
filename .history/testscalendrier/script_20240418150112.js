document.addEventListener("DOMContentLoaded", function() {
    ...
    function sendDataToDatabase(data) {
        // Utilisez ici une requête AJAX pour envoyer les données à votre serveur
        console.log("Données envoyées à la base de données :", data);
        // Ici, vous devez écrire le code pour envoyer les données à votre serveur et les insérer dans la base de données
    }
});
